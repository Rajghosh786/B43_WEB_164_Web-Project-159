...
function Home() {
  ...
  if(loading){
      return <div className="text-xl font-semibold text-gray-700 text-center">Loading Data...</div>
  }
  if(error){
    return <div className="text-xl font-semibold text-gray-700 text-center">error</div>
  }
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-100 to-gray-200">
      <div className="container mx-auto p-4">
        ...
        <div className="flex justify-center mt-8">
          ...
          <span className="px-4 py-2 text-lg">{pageNumber} of {resultCount}</span>
          <button
            className="px-4 py-2 mx-2 bg-indigo-500 text-white rounded-lg hover:bg-blue-600"
            onClick={next}
          >
